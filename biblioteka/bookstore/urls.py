...
# Shared URL's
 ...
 path('ldrequest/', views.LBookReservation.as_view(), name='ldrequest'),
 ...
 path('book_resevation/', views.book_reservation, name='book_reservation'),
...
# User URL's
 ...
 path('ucchat/', views.UCreateChat.as_view(), name='ucchat'),
 path('ulchat/', views.UListChat.as_view(), name='ulchat'),
 path('urequest_form/', views.user_request_form, name='user_request_form'),
